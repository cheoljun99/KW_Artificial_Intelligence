...
def policy_improvement_normally(value, action, policy, grid_width):
...
optimal_value = policy_evaluation(grid_width, grid_height, action, policy, 3000)

policy_improvement_normally(optimal_value, action, policy,grid_width)
